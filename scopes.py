...
# la fonction voit les variables définies au préalable ou à posteriori
my_func1()

def my_func2():
    my_var3 = 3.14
print(my_func2)
# Il n'est pas possible d'accéder à une variable définie à l'intérieur d'une fonction, que celle-ci ait été éxecuté ou non
...
# c-à-d que la fonction ne pourra accéder qu'à une copie de la variable originale définie à l'extérieur
...
my_var8 = [123, 42, 3.14]
# les variables de type list, dict, tuple, dictionnaire ou objet sont passées par référence
